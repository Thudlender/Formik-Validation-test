...
const RegistrationForm = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    idCard: Yup.string()
      .required("Required")
      .min(13, "กรุณาใส่ให้ครบ 13 หลัก")
      .max(13, "กรุณาใส่ให้ครบ 13 หลัก"),
    password: Yup.string()
      .required("Required")
      .min(8, "กรุณาใส่ให้มันครบ 8 ตัว"),
    mobile: Yup.string()
      .required("Required")
      .min(10, "กรุณาใส่เบอร์ให้ครบ 10 ตัว")
      .max(10, "กรุณาใส่เบอร์ให้ครบ 10 ตัว"),
    email: Yup.string()
